	...
	: m_camera(Vector(0, -5, 0), Vector(0, 0, 0), Vector(0, 0, 1))
{
	...
	m_pLight1 = new Light(Vector(2, 4, 5), Color::White * 0.15f, Color::White * 1.0f, Color::White * 0.7f, 1.0f, 0.1f, 0.0f);
	m_pLight2 = new Light(Vector(-2, -6, 2), Color::White * 0.15f, Color::White * 1.0f, Color::White * 0.7f, 1.0f, 0.1f, 0.0f);
